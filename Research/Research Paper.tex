...
As mentioned before, the usage of embedded devices in households, factories, infrastructure objects is about to increase, therefore the security should increase as well.
