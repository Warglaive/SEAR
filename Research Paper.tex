...
\end{itemize}
\end{enumerate}
The collected data can be both qualitative and quantitative even though, we shall rely mainly on qualitative data.
Quantitative data is only used to compare numbers and statistics and derive results in numeric form.
\section{Data types}
The data that shall be gathered and analysed for the needs of this research shall be of several types:
Observation Data
